...
import com.acmebank.ordermanagementservice.sellingpower.application.eventlistener.SellingPowerUpdateCommandApiListener
...
class SellingPowerModuleConfiguration {
    ...
    fun sellingPowerOrderFilledEventListener(sellingPowerDomainService: SellingPowerDomainService) =
        SellingPowerUpdateCommandApiListener(sellingPowerDomainService)
