...
import com.acmebank.ordermanagementservice.sellingpower.application.eventlistener.OrderFilledEventListener
...
class SellingPowerModuleConfiguration {
    ...
    fun orderFilledEventListener(sellingPowerRepository: SellingPowerRepository) =
        OrderFilledEventListener(sellingPowerRepository)
}